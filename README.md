...
| :--- | :--- | :--- |
| **Dictionary Path** | Directory containing dictionary `.md` files (relative or absolute). | `dictionary_folder` |
...
| 設定項目 | 說明 | 預設值 |
| :--- | :--- | :--- |
| **辭典目錄路徑** | 存放辭典 `.md` 檔案的資料夾路徑。支援相對路徑（如 `dictionary_folder`）或電腦絕對路徑。 | `dictionary_folder` |
